...
/*window.location.href = '/getCouponMemberListPage?couponID=${couponDatas.couponID}';*/
//<script>
//    // 각 tr에 클릭 이벤트를 추가합니다.
//var rows = document.getElementsByClassName("couponRow");
//for (var i = 0; i < rows.length; i++) {
//    rows[i].addEventListener("click", function() {
//        var couponID = this.dataset.couponid; 
//        var destinationURL = "/getCouponMemberListPage?couponID=" + couponID;
...
//  // 테이블에서 각 행을 선택합니다.
//  var rows = document.querySelectorAll('.couponRow');
//  
//  // 각 행에 대해 클릭 이벤트를 추가합니다.
//  rows.forEach(function(row) {
//    row.addEventListener('click', function() {
//      // 클릭된 행에서 couponID 값을 가져옵니다.
//      var couponID = row.getAttribute('value');
//      
//      // couponID를 사용하여 원하는 작업을 수행합니다.
//      console.log("Clicked row's couponID:", couponID);
//    });
//  });
//});
//</script>
